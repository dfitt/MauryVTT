...
export function openVttfxPreviewModal(vttfxItem: VttfxEffectItem, iconDesc: string, animDesc: string, proxyPeerId: string | null): void {
  ...
  importBtn.addEventListener("click", () => {
    ...
    const newMsg: ChatMessage = {
      ...
      content: `✨ AI Roll Animation <strong>${vttfxItem.name}</strong> generated by ${username} and added to animation library!${wasSelectedForRoll ? " (Selected for active dice roll)" : ""}`,
      type: "system"
    };
