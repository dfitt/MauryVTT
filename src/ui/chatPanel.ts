    ...
    <div class="dice-builder-section" id="dice-builder-section">
      ...
      <div class="dice-builder-details" id="dice-builder-details" style="display: none;">
        ...
        <div id="dice-builder-icon-popover" style="display: none; width: 100%; box-sizing: border-box; background: rgba(15, 23, 42, 0.98); border: 1px solid rgba(56, 189, 248, 0.6); border-radius: 8px; padding: 8px; flex-direction: row; justify-content: center; flex-wrap: wrap; gap: 8px; box-shadow: inset 0 0 12px rgba(0, 0, 0, 0.5);">
          ...
          <button class="btn-glass roll-icon-swatch" data-icon='<svg viewBox="0 0 64 64" width="1.1em" height="1.1em" style="vertical-align:middle; display:inline-block;"><path d="M12 52 L52 12" stroke="#78350f" stroke-width="4.5" stroke-linecap="round"/><path d="M14 50 L50 14" stroke="#92400e" stroke-width="2" stroke-linecap="round"/><path d="M38 12 L56 22 C62 14 62 6 56 0 C50 -6 42 -6 38 12 Z" fill="#94a3b8" stroke="#475569" stroke-width="1.5"/><path d="M42 16 L50 24 C54 18 54 12 50 8 C46 4 42 8 42 16 Z" fill="#e2e8f0"/><path d="M26 24 L44 42 C52 48 52 56 44 62 C36 68 28 68 26 52 Z" fill="#94a3b8" stroke="#475569" stroke-width="1.5"/><path d="M30 28 L38 36 C42 40 42 46 38 50 C34 54 30 50 30 42 Z" fill="#e2e8f0"/><circle cx="32" cy="32" r="4.5" fill="#f59e0b" stroke="#78350f" stroke-width="1"/></svg>' style="padding: 6px 10px; font-size: 1.25em; cursor: pointer; border-radius: 6px;"><svg viewBox="0 0 64 64" width="1.1em" height="1.1em" style="vertical-align:middle; display:inline-block;"><path d="M12 52 L52 12" stroke="#78350f" stroke-width="4.5" stroke-linecap="round"/><path d="M14 50 L50 14" stroke="#92400e" stroke-width="2" stroke-linecap="round"/><path d="M38 12 L56 22 C62 14 62 6 56 0 C50 -6 42 -6 38 12 Z" fill="#94a3b8" stroke="#475569" stroke-width="1.5"/><path d="M42 16 L50 24 C54 18 54 12 50 8 C46 4 42 8 42 16 Z" fill="#e2e8f0"/><path d="M26 24 L44 42 C52 48 52 56 44 62 C36 68 28 68 26 52 Z" fill="#94a3b8" stroke="#475569" stroke-width="1.5"/><path d="M30 28 L38 36 C42 40 42 46 38 50 C34 54 30 50 30 42 Z" fill="#e2e8f0"/><circle cx="32" cy="32" r="4.5" fill="#f59e0b" stroke="#78350f" stroke-width="1"/></svg></button>
          <button class="btn-glass roll-icon-swatch" data-icon="🛡️" style="padding: 6px 10px; font-size: 1.25em; cursor: pointer; border-radius: 6px;">🛡️</button>
          <button class="btn-glass roll-icon-swatch" data-icon="❄️" style="padding: 6px 10px; font-size: 1.25em; cursor: pointer; border-radius: 6px;">❄️</button>
        </div>
      </div>
